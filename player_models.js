...
Blockbench.addMenuEntry('Create Cape','turned_in', function(){
	var confirmation = new Dialog({title:'Cape Texture Warning',id:"cape_texture_warning",lines:['Your might need to edit your cape texture<br /> to a square format(32x32) to make it work in-game!<br /> ','<span style="text-decoration: underline;"><a class="open-in-browser" href="http://bit.ly/2xB4Utq" target="_blank">Click here</a></span>',' to get the texture template.'],draggable:true,onConfirm() {
		hideDialog()
		generateCape()
	}})
	confirmation.show()
...
function generateSteve(){
    ...
    steveModel.faces.down.uv = [2.01, 4.01, 2.99, 4.99]
    ...
    steveModel.faces.down.rotation = 180
    ...
    steveModel.faces.down.uv = [6.01, 12.01, 6.99, 12.99]
    steveModel.faces.north.texture = '#0'
    steveModel.faces.east.texture = '#0'
    steveModel.faces.south.texture = '#0'
    steveModel.faces.west.texture = '#0'
    ...
    steveModel.faces.down.uv = [7.01, 4.01, 8.99, 4.99]
    steveModel.faces.north.texture = '#0'
    steveModel.faces.east.texture = '#0'
    steveModel.faces.south.texture = '#0'
    steveModel.faces.west.texture = '#0'
    ...
    steveModel.faces.down.uv = [4.01, 0.01, 5.99, 1.99]
    steveModel.faces.north.texture = '#0'
    steveModel.faces.east.texture = '#0'
    steveModel.faces.south.texture = '#0'
    steveModel.faces.west.texture = '#0'
    ...
    steveModel.faces.east.uv = [10.01, 5.01, 10.99, 7.99]
    steveModel.faces.south.uv = [11.01, 5.01, 11.99, 7.99]
    steveModel.faces.west.uv = [12.01, 5.01, 12.99, 7.99]
    steveModel.faces.up.uv = [11.01, 4.01, 11.99, 4.99]
    steveModel.faces.down.uv = [12.01, 4.01, 12.99, 4.99]
    steveModel.faces.north.texture = '#0'
    steveModel.faces.east.texture = '#0'
    steveModel.faces.south.texture = '#0'
    steveModel.faces.west.texture = '#0'
    ...
    steveModel.faces.east.uv = [8.01, 13.01, 8.99, 15.99]
    steveModel.faces.south.uv = [9.01, 13.01, 9.99, 15.99]
    steveModel.faces.west.uv = [10.01, 13.01, 10.99, 15.99]
    steveModel.faces.up.uv = [9.01, 12.01, 9.99, 12.99]
    steveModel.faces.down.uv = [10.01, 12.01, 10.99, 12.99]
    steveModel.faces.north.texture = '#0'
    steveModel.faces.east.texture = '#0'
    steveModel.faces.south.texture = '#0'
    steveModel.faces.west.texture = '#0'
    ...
    steveModel.faces.down.uv = [12.01, 0.01, 13.99, 1.99]
    steveModel.faces.north.texture = '#0'
    steveModel.faces.east.texture = '#0'
    steveModel.faces.south.texture = '#0'
    steveModel.faces.west.texture = '#0'
    ...
    steveModel.faces.down.uv = [7.01, 8.01, 8.99, 8.99]
    steveModel.faces.north.texture = '#0'
    steveModel.faces.east.texture = '#0'
    steveModel.faces.south.texture = '#0'
    steveModel.faces.west.texture = '#0'
    ...
    steveModel.faces.east.uv = [10.01, 9.01, 10.99, 11.99]
    ...
    steveModel.faces.down.uv = [12.01, 8.01, 12.99, 8.99]
    steveModel.faces.north.texture = '#0'
    steveModel.faces.east.texture = '#0'
    steveModel.faces.south.texture = '#0'
    steveModel.faces.west.texture = '#0'
    ...
    steveModel.faces.east.uv = [12.01, 13.01, 12.99, 15.99]
    steveModel.faces.south.uv = [13.01, 13.01, 13.99, 15.99]
    steveModel.faces.west.uv = [14.01, 13.01, 14.99, 15.99]
    steveModel.faces.up.uv = [13.01, 12.01, 13.99, 12.99]
    steveModel.faces.down.uv = [14.01, 12.01, 14.99, 12.99]
    steveModel.faces.north.texture = '#0'
    steveModel.faces.east.texture = '#0'
    steveModel.faces.south.texture = '#0'
    steveModel.faces.west.texture = '#0'
...
function generateAlex(){
    ...
    alexModel.from = [4.01, -0.5, 6]
    alexModel.to = [8.01, 11.5, 10]
    alexModel.name = "alex_right_leg"
    alexModel.display.autouv = false
    alexModel.faces.north.uv = [3.005, 5.005, 3.995, 7.995]
    alexModel.faces.east.uv = [2.005, 5.005, 2.995, 7.995]
    alexModel.faces.south.uv = [1.005, 5.005, 1.9949999999999999, 7.995]
    alexModel.faces.west.uv = [0.005, 5.005, 0.995, 7.995]
    alexModel.faces.up.uv = [1.005, 4.005, 1.9949999999999999, 4.995]
    alexModel.faces.down.uv = [2.005, 4.005, 2.995, 4.25]
    ...
    alexModel.faces.down.rotation = 180
    Canvas.updatePositions()

    //left leg
    var alexModel = addCube()
    alexModel.from = [8.01, -0.5, 6]
    alexModel.to = [12.01, 11.5, 10]
    alexModel.name = "alex_left_leg"
    alexModel.display.autouv = false
    alexModel.faces.north.uv = [8.005, 13.005, 7.015000000000001, 15.995000000000001]
    alexModel.faces.east.uv = [6.005, 13.005, 6.995, 15.995000000000001]
    alexModel.faces.south.uv = [5.005, 13.005, 5.99, 15.99]
    alexModel.faces.west.uv = [4.005, 13.005, 4.995, 15.995000000000001]
    alexModel.faces.up.uv = [5.005, 12.005, 5.995, 12.995000000000001]
    alexModel.faces.down.uv = [6.005, 12.005, 6.995, 12.995000000000001]
    alexModel.faces.north.texture = '#0'
    alexModel.faces.east.texture = '#0'
    alexModel.faces.south.texture = '#0'
    alexModel.faces.west.texture = '#0'
    ...
    //body
    var alexModel = addCube()
    alexModel.from = [4, 11.5, 6]
    alexModel.to = [12, 23.5, 10]
    alexModel.name = "alex_body"
    alexModel.display.autouv = false
    alexModel.faces.north.uv = [8.005, 5.005, 9.995000000000001, 7.995]
    alexModel.faces.east.uv = [7.005, 5.005, 7.994999999999999, 7.995]
    alexModel.faces.south.uv = [5.005, 5.005, 6.995, 7.995]
    alexModel.faces.west.uv = [4.005, 5.005, 4.995, 7.995]
    alexModel.faces.up.uv = [5.005, 4.005, 6.995, 4.995]
    alexModel.faces.down.uv = [7.005, 4.005, 8.995, 4.995]
    alexModel.faces.north.texture = '#0'
    alexModel.faces.east.texture = '#0'
    alexModel.faces.south.texture = '#0'
    alexModel.faces.west.texture = '#0'
    ...
    alexModel.display.autouv = false
    alexModel.faces.north.uv = [6.005, 2.005, 6.995, 3.995]
    alexModel.faces.east.uv = [4.005, 2.005, 5.995, 3.995]
    alexModel.faces.south.uv = [2.005, 2.005, 3.995, 3.995]
    alexModel.faces.west.uv = [0.005, 2.005, 1.9949999999999999, 3.995]
    alexModel.faces.up.uv = [2.005, 0.005, 3.995, 1.9949999999999999]
    alexModel.faces.down.uv = [4.005, 0.005, 5.995, 1.9949999999999999]
    alexModel.faces.north.texture = '#0'
    alexModel.faces.east.texture = '#0'
    alexModel.faces.south.texture = '#0'
    alexModel.faces.west.texture = '#0'
    ...
    alexModel.faces.up.uv = [11.005, 4.005, 11.995000000000001, 4.995]
    alexModel.faces.down.uv = [11.755, 4.005, 12.495000000000001, 4.995]
    alexModel.faces.north.texture = '#0'
    alexModel.faces.east.texture = '#0'
    alexModel.faces.south.texture = '#0'
    alexModel.faces.west.texture = '#0'
    ...
    //left arm
    var alexModel = addCube()
    alexModel.from = [12.0, 11.5, 6.0]
    alexModel.to = [15.0, 23.5, 10.0]
    ...
    alexModel.faces.west.uv = [10.005, 13.005, 10.995000000000001, 15.995000000000001]
    alexModel.faces.up.uv = [9.005, 12.005, 9.745000000000001, 12.995000000000001]
    alexModel.faces.down.uv = [9.755, 12.005, 10.495000000000001, 12.995000000000001]
    alexModel.faces.north.texture = '#0'
    alexModel.faces.east.texture = '#0'
    alexModel.faces.south.texture = '#0'
    alexModel.faces.west.texture = '#0'
    ...
    alexModel.display.autouv = false
    alexModel.faces.north.uv = [14.005, 2.005, 15.995000000000001, 3.995]
    alexModel.faces.east.uv = [12.005, 2.005, 13.995000000000001, 3.995]
    alexModel.faces.south.uv = [10.005, 2.005, 11.995000000000001, 3.995]
    alexModel.faces.west.uv = [8.005, 2.005, 9.995000000000001, 3.995]
    alexModel.faces.up.uv = [10.005, 0.005, 11.995000000000001, 1.9949999999999999]
    alexModel.faces.down.uv = [12.005, 0.005, 13.995000000000001, 1.9949999999999999]
    alexModel.faces.north.texture = '#0'
    alexModel.faces.east.texture = '#0'
    alexModel.faces.south.texture = '#0'
    alexModel.faces.west.texture = '#0'
    ...
    alexModel.display.autouv = false
    alexModel.faces.north.uv = [8.005, 9.005, 9.995000000000001, 11.995000000000001]
    alexModel.faces.east.uv = [7.005, 9.005, 7.995, 11.995000000000001]
    alexModel.faces.south.uv = [5.005, 9.005, 6.995, 11.995000000000001]
    alexModel.faces.west.uv = [4.005, 9.005, 4.995, 11.995000000000001]
    alexModel.faces.up.uv = [5.005, 8.005, 6.995, 8.995000000000001]
    alexModel.faces.down.uv = [7.005, 8.005, 8.995, 8.995000000000001]
    alexModel.faces.north.texture = '#0'
    alexModel.faces.east.texture = '#0'
    alexModel.faces.south.texture = '#0'
    alexModel.faces.west.texture = '#0'
    ...
    alexModel.faces.up.uv = [11.005, 8.005, 11.995000000000001, 8.995000000000001]
    alexModel.faces.down.uv = [12.005, 8.005, 12.995000000000001, 8.995000000000001]
    alexModel.faces.north.texture = '#0'
    alexModel.faces.east.texture = '#0'
    alexModel.faces.south.texture = '#0'
    alexModel.faces.west.texture = '#0'
    ...
    alexModel.faces.down.uv = [14.005, 12.005, 14.995000000000001, 12.995000000000001]
    alexModel.faces.north.texture = '#0'
    alexModel.faces.east.texture = '#0'
    alexModel.faces.south.texture = '#0'
    alexModel.faces.west.texture = '#0'
    ...
    alexModel.display.autouv = false
    alexModel.faces.north.uv = [3.005, 9.005, 3.995, 11.995000000000001]
    alexModel.faces.east.uv = [2.005, 9.005, 2.995, 11.995000000000001]
    alexModel.faces.south.uv = [1.005, 9.005, 1.9949999999999999, 11.995000000000001]
    alexModel.faces.west.uv = [0.005, 9.005, 0.995, 11.995000000000001]
    alexModel.faces.up.uv = [1.005, 13.005, 1.9949999999999999, 12.015]
    alexModel.faces.down.uv = [2.005, 9.005, 2.995, 8.015]
    alexModel.faces.north.texture = '#0'
    alexModel.faces.east.texture = '#0'
    alexModel.faces.south.texture = '#0'
    alexModel.faces.west.texture = '#0'
    ...
    alexModel.display.autouv = false
    alexModel.faces.north.uv = [3.005, 13.005, 3.995, 15.995000000000001]
    alexModel.faces.east.uv = [2.005, 13.005, 2.995, 15.995000000000001]
    alexModel.faces.south.uv = [1.005, 13.005, 1.9949999999999999, 15.995000000000001]
    alexModel.faces.west.uv = [0.005, 13.005, 0.995, 15.995000000000001]
    alexModel.faces.up.uv = [1.005, 13.005, 1.9949999999999999, 0]
    alexModel.faces.down.uv = [2.005, 13.005, 2.995, 12.015]
    alexModel.faces.north.texture = '#0'
    alexModel.faces.east.texture = '#0'
    alexModel.faces.south.texture = '#0'
    alexModel.faces.west.texture = '#0'
...
function generateCape(){
    ...
    cape.faces.down.uv = [5.498766447368421, 0, 10.497818796258223, 0.49971379731830795]
